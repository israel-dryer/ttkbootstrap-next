...
class EntryMixin:
    ...
    def delete_text(self, first: int, last: int):
        ...
        self._entry.delete_text(first, last)
        return self

    def insert_text(self, index: int, text: str):
        """Insert text at index."""
        self._entry.insert_text(index, text)
        return self

    def set_cursor_index(self, index: int):
        """Set the cursor position."""
        self._entry.set_cursor_index(index)
        return self
    ...
    def add_validation_rules(self, rules: list[ValidationRule]):
        self._entry.add_validation_rules(rules)
        return self
