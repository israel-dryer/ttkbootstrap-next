...
from ttkbootstrap_next.core.layout_context import current_container
from ttkbootstrap_next.core.mixins.layout import LayoutMixin
from ttkbootstrap_next.events import Event
from ttkbootstrap_next.interop.runtime.binding import BindingMixin
from ttkbootstrap_next.interop.runtime.configure import ConfigureMixin, configure_delegate
from ttkbootstrap_next.interop.runtime.focus import FocusMixin
from ttkbootstrap_next.interop.runtime.grab import GrabMixIn
from ttkbootstrap_next.interop.runtime.schedule import Schedule
from ttkbootstrap_next.interop.runtime.winfo import WidgetInfoMixin
from ttkbootstrap_next.types import Widget
from ttkbootstrap_next.utils import resolve_parent, unsnake_kwargs
...
class BaseWidget(
    ...
    def __init__(
        ...
        from ttkbootstrap_next.core.widget_registry import register as _register
    ...
    def custom_id(self) -> str | None:
        from ttkbootstrap_next.core.widget_registry import get_id as _get_id
        return _get_id(self)

    @custom_id.setter
    def custom_id(self, value: str | None) -> None:
        from ttkbootstrap_next.core.widget_registry import set_id as _set_id
        _set_id(self, value)

    def destroy(self):
        """Destroy the underlying widget."""
        try:
            from ttkbootstrap_next.core.widget_registry import unregister as _unregister
            _unregister(self)
        finally:
            self.widget.destroy()
