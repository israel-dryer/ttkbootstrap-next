...
from ttkbootstrap_next.logging import logger
...
class Icon(ABC):
    ...
    def initialize(cls, icon_set: str):
        ...
        assets = files("ttkbootstrap_next.assets.icons")
    ...
    def cleanup(cls):
        ...
        if cls._font_path and os.path.exists(cls._font_path):
            try:
                ...
                logger.error("Icon", f"Error cleaning up icon: {e}")
