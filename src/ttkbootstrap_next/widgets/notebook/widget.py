...
from ttkbootstrap_next.exceptions.base import NavigationError
...
from ttkbootstrap_next.types import UIEvent, Widget
from ttkbootstrap_next.widgets.notebook.events import (
    NotebookChangedEvent,
    NotebookTabActivatedEvent,
    NotebookTabDeactivatedEvent
)
from ttkbootstrap_next.widgets.notebook.style import NotebookStyleBuilder
from ttkbootstrap_next.widgets.notebook.tab import Tab, TabGrid, TabPack
from ttkbootstrap_next.widgets.notebook.types import (
