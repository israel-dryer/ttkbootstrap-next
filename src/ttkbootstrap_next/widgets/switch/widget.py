...
from ttkbootstrap_next.widgets.switch.events import SwitchChangedEvent, SwitchInvokeEvent
from ttkbootstrap_next.widgets.switch.style import SwitchStyleBuilder
from ttkbootstrap_next.widgets.switch.types import SwitchOptions
