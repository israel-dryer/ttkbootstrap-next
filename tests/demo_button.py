...
with App("Button Demo", theme="dark") as app:
    ...
    with GridBox(sticky="nsew", padding=16, gap=16):
            ...
            with GridBox(columns=3, rows=1, sticky="new", expand=True, gap=16, padding=16, surface="background-3", height=200, propagate=False):
