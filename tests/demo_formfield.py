...
from ttkbootstrap.widgets import Frame, NumberEntry, Button, FileEntry
...
te = TextEntry(frame, value="Israel Dryer", label="First Name", message="What are you called?").pack(fill='x', pady=16)
te.insert_addon(Button, text="Name", side="left")
